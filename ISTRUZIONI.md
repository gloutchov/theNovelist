...
Per richiamare un personaggio, o una location, è sufficiente digitare '@' e scegliere dall'elenco. Il richiamo non sarà visibile in fase di export, ma permetterà di avere una correlazione tra gli elementi, visibile sia nell'editor, sia nelle schede personaggio e nelle schede paesaggio. Al salvataggio, l'editor controlla anche le citazioni scritte normalmente nel testo: se trova un personaggio o una location già esistenti senza badge, inserisce automaticamente il relativo riferimento @ e sincronizza il collegamento con il capitolo. Per evitare agganci sbagliati, il controllo automatico salta nomi, cognomi o location non univoci.
