export const IPC_CHANNELS = {
  ...
  externalSourcesGetState: 'external-sources:get-state',
  externalSourcesImport: 'external-sources:import',
  externalSourcesUpdate: 'external-sources:update',
  externalSourcesDelete: 'external-sources:delete',
  externalSourcesOpen: 'external-sources:open',
  externalSourcesCreateEdge: 'external-sources:create-edge',
  externalSourcesDeleteEdge: 'external-sources:delete-edge',
