...
const CODEX_TEXT = {
  it: {
    ...
    chatMemoryRules: [
      ...
      '- non trascrivere lunghi passaggi delle fonti: rispondi con sintesi, dettagli puntuali e brevi citazioni solo se indispensabili;',
  ...
  en: {
    ...
    chatMemoryRules: [
      ...
      '- do not transcribe long passages from sources: answer with summaries, precise details, and short quotes only when necessary;',
